...
const DetailNurseRouter = require('./routers/detail-nurse.r');
// const DetailPatientsAndDisease=require('./routers/list-patient-disease.r')
...
app.use('/y-ta', DetailNurseRouter);
// app.use('/bao-cao-benh-nhan', DetailPatientsAndDisease);
